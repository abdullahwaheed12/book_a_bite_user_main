...
import 'package:book_a_bite_user/modules/sign_up/state.dart';
...
class PhoneSignUpView extends StatefulWidget {
  ...
  @override
  _PhoneSignUpViewState createState() => _PhoneSignUpViewState();
}
...
class _PhoneSignUpViewState extends State<PhoneSignUpView>
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SignUpLogic>(
      builder: (signUpLogic) => GestureDetector(
        onTap: () {
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: DecoratedBox(
                            ...
                            child: IntlPhoneField(
                              ...
                              controller: signUpLogic.phoneController,
                              ...
                              onChanged: (phone) {
                                setState(() {
                                  signUpLogic.updateOtpSendCheckerLogin(false);
                                  signUpLogic.phoneNumber =
                              ...
                              onCountryChanged: (Country? phone) {
                                signUpLogic.updateOtpSendCheckerLogin(false);
                                signUpLogic.phoneController.clear();
                                signUpLogic.phoneNumber = null;
                                setState(() {});
                        ...
                        signUpLogic.otpSendCheckerLogin!
                            ? Padding(
                                      ...
                                      child: Center(
                                        child: InkWell(
                                          onTap: () {
                                            ...
                                            signUpLogic.verifyOTP(
                                                context, signUpLogic.phoneOtp);
                                          },
                                          child: Container(
                                            height: 55,
                                  ...
                                  onTap: () async {
                                    ...
                                    if (_phoneFormKey.currentState!
                                      ...
                                      signUpLogic.otpFunction(
                                          ...
                                          context);
                                      signUpLogic.loginTimerAnimationController!
                                          .reverse(
                                              from: signUpLogic
                                                          .loginTimerAnimationController!
                                                          .value ==
