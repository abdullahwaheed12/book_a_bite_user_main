...
import 'package:book_a_bite_user/modules/edit_profile/view_map.dart';
...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<EditProfileLogic>(
      builder: (editProfileLogic) => GetBuilder<GeneralController>(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: (editProfileLogic.downloadURL == null ||
                                    editProfileLogic.downloadURL!.isEmpty)
                                ? editProfileLogic.userImage != null
                                    ? ClipRRect(
                                        borderRadius: BorderRadius.circular(10),
                                        child: Image.file(
                                          editProfileLogic.userImage!,
                                          fit: BoxFit.cover,
                                        ))
                                    : const Icon(
                                        Icons.add_a_photo,
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            controller: editProfileLogic.nameController,
                        ...
                        Get.find<GeneralController>()
                            ...
                            : Padding(
                                ...
                                child: TextFormField(
                                  controller: editProfileLogic.emailController,
                            ...
                            : Padding(
                                ...
                                child: DecoratedBox(
                                  ...
                                  child: IntlPhoneField(
                                    ...
                                    controller:
                                        editProfileLogic.phoneController,
                                    style:
                                    ...
                                    onCountryChanged: (phone) {
                                      editProfileLogic.phoneController.clear();
                                      setState(() {});
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            controller: editProfileLogic.addressController,
