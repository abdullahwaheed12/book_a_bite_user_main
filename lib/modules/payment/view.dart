...
class _PaymentPageState extends State<PaymentPage> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<GeneralController>(
      builder: (generalController) => GetBuilder<PaymentLogic>(
        builder: (paymentLogic) => ModalProgressHUD(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              InkWell(
                                onTap: () async {
                                  paymentLogic.updateRadioValue(
                                      paymentLogic.cardRadioGroupValue);
                                ...
                                children: [
                                  InkWell(
                                    onTap: () async {
                                      ...
                                      //               .toString()))
                                      //       .then((token) async {
                                      //     log('Token-for charity-->>${token.tokenId}');

                                      //     Get.find<PaymentLogic>()
                                      //             .paymentTokenForChairty =
                                      //         token.tokenId;
                                      //     log('Token-->>${Get.find<PaymentLogic>().paymentTokenForChairty}');
