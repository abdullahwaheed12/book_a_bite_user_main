...
import 'package:book_a_bite_user/Models/review.dart';
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Did you purchase additional full priced food or beverage items from the Bite Hub at the time of collecting your order? If yes, what did you purchase?',
                            style: state.titleTextStyle,
                          ),
              ...
              onTap: () async {
                if (ratingValue1 != 0 &&
                  ...
                  if (query1.docs.isNotEmpty) {
                    ...
                    ///---bite_points
                    QuerySnapshot zeroHeroesQuery = await FirebaseFirestore
                        .instance
                    ...
                    if (zeroHeroesQuery.docs.isNotEmpty) {
                      FirebaseFirestore.instance
                          ...
                          .update({
                        'bite_points': FieldValue.increment(2),
                      });
                    }
                    ...
                    FirebaseFirestore.instance
                        ...
                        .set({
                      'uid':
                          Get.find<GeneralController>().boxStorage.read('uid'),
                      'points': 2,
