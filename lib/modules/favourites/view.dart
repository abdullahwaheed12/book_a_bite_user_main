                    ...
                    if (wishListSnapshot.data!.docs.isEmpty) {
                      return Column(
                        children: [
                          ...
                          Padding(
                              ...
                              child: Text(
                                'For quick access view your favourite Bite Hubs and Items here.',
                      ...
                      return Wrap(
                        children: List.generate(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                              ...
                                                                              child: Text('${productsSnapshot.data!.docs[index].get('quantity')} left', style: GoogleFonts.nunito(fontSize: 14, fontWeight: FontWeight.w700, color: customTextGreyColor.withOpacity(0.5))),
                                                                            ),
                                                                          ),
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                              ...
                                                                              child: Text('${distance}km', style: GoogleFonts.nunito(fontSize: 14, fontWeight: FontWeight.w700, color: customTextGreyColor.withOpacity(0.5))),
                                                                            ),
                                                                          ),
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                                Align(
                                                                              alignment: Alignment.center,
                                                                              child: Text('\$${productsSnapshot.data!.docs[index].get('original_price')}', style: GoogleFonts.nunito(fontSize: 14, fontWeight: FontWeight.w700, color: customTextGreyColor.withOpacity(0.5)).copyWith(decoration: TextDecoration.lineThrough)),
                                                                            ),
                                                                          ),
                                                                        ],
                                                                      ),
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                                Align(
                                                                              alignment: Alignment.centerLeft,
                                                                              child: Text('${productsSnapshot.data!.docs[index].get('discount')}% off', style: GoogleFonts.nunito(fontSize: 14, fontWeight: FontWeight.w700, color: customTextGreyColor.withOpacity(0.5)).copyWith(color: Colors.green)),
                                                                            ),
                                                                          ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: Center(
                                                                                    child: Text('\$${productsSnapshot.data!.docs[index].get('dis_price')}', style: GoogleFonts.nunito(fontSize: 14, fontWeight: FontWeight.w700, color: customTextGreyColor.withOpacity(0.5)).copyWith(color: Colors.white)),
                                                                                  ),
                                                                                ),
                                                                              ),
                                                                            ),
                          ...
                          } else if (wishListSnapshot.data!.docs[index]
                                  .get('type') ==
                              'restaurants') {
                            //restaurants wish list
                            return StreamBuilder<QuerySnapshot>(
                                                    ...
                                                    child: InkWell(
                                                      onTap: () {
                                                        Get.to(
                                                          ...
                                                          index: index,
                                                          imageForBag:
                                                              "${restaurantsSnapshot.data!.docs[index]['image']}",
                                                        ));
                                                      },
                                                      child: Container(
                                                        width: MediaQuery.of(
