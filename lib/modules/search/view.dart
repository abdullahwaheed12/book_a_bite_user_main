                                                        ...
                                                        Expanded(
                                                          child: Align(
                                                            alignment: Alignment
                                                                .center,
                                                            child: Text(
                                                                '\$${_searchLogic.tempSearchForProductStore[index].get('original_price')}',
                                                                style: state
                                                                    .priceTextStyle!
                                                                    .copyWith(
                                                                        decoration:
                                                          ...
                                                          child: Align(
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Center(
                                                                  child: Text(
                                                                      '\$${_searchLogic.tempSearchForProductStore[index].get('dis_price')}',
                                                                      style: state
                                                                          .priceTextStyle!
                                                                          .copyWith(
                                                                              color: Colors.white)),
                      ...
                      ? Column(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                'Try searching for the Bite or Bite Hub with a different keyword',
