          ...
          child: Padding(
            ...
            child: ListView(
              children: [
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(boxShadow: [
                              BoxShadow(
                                ...
                                spreadRadius: 0,
                                offset: const Offset(
                                    22, 10), // changes position of shadow
                              ),
                ...
                ///---name
                Padding(
                  padding: const EdgeInsets.fromLTRB(0, 40, 0, 0),                  child: Text('${widget.restaurantModel!.get('name')}',
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Center(
                                                                            child:
                                                                                Text('\$${snapshot.data!.docs[index].get('dis_price')}', style: state.priceTextStyle!.copyWith(color: Colors.white)),
                                                                          ),
                                                                        ),
                                                                      ),
                                                                    ),
