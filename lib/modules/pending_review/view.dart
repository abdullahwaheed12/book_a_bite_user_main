...
import 'package:book_a_bite_user/modules/rating_review/view.dart';
          ...
          body: ListView(
            children: [
              Padding(
                  ...
                  child: Text(
                    'Take a minute to review each order you make to redeem extra bite points on your profile.',
                                                        ...
                                                        child: Align(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: Center(
                                                                child: Text(
                                                                    '\$${snapshot.data!.docs[index].get('grand_total')}',
                                                                    style: state
                                                                        .priceTextStyle!
                                                                        .copyWith(
                                                                            color:
