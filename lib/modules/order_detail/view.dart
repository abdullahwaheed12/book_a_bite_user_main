              ...
              children: [
                ...
                Center(
                  child: Container(
                    ...
                    child: Center(
                      child: Text(
                        'Bite Code: ${widget.orderModel!.get('otp')}',
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: Align(
                                                alignment: Alignment.centerLeft,
                                                child: Text(
                                                    '\$${widget.orderModel!.get('product_list')[index]['original_price']}',
                                                    style: state
                                            ...
                                            Expanded(
                                              child: Align(
                                                alignment: Alignment.centerLeft,
                                                child: Text(
                                                    '\$${widget.orderModel!.get('product_list')[index]['dis_price']}',
                                                    style: state
                                                        .productPriceTextStyle!
                                                        .copyWith(
                                                            color:
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '\$${double.parse(widget.orderModel!.get('total_price').toString()).toPrecision(2)}',
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '\$${(double.parse(widget.orderModel!.get('total_discount').toString()) - double.parse(widget.orderModel!.get('coupon_discount').toString())).toPrecision(2)}',
                        style: state.billValueTextStyle,
                      ),
                    ],
                  ),
                  ...
                  //     ),
                  //     Text(
                  //       '\$${widget.orderModel!.get('net_price')}',
                  //       style: state.billValueTextStyle,
                  //     ),
                  //   ],
                  // ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '\$${(double.parse(widget.orderModel!.get('grand_total').toString()) - double.parse(widget.orderModel!.get('coupon_discount').toString())).toPrecision(4)}',
                        style: state.grandTotalTextStyle,
                      ),
                    ],
                  ),
