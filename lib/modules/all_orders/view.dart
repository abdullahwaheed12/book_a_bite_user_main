...
import 'package:book_a_bite_user/modules/order_detail/view.dart';
                                                            ...
                                                            child: Align(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child: Center(
                                                                    child: Text(
                                                                        '\$${(double.parse(snapshot.data!.docs[index].get('grand_total').toString()) - double.parse(snapshot.data!.docs[index].get('coupon_discount').toString())).toPrecision(2)}',
                                                                        style: state
                                                                            .priceTextStyle!
                                                                            .copyWith(color: Colors.white)),
                                                                  ),
