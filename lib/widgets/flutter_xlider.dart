...
//             _containerWidth =
//                 [(sliderProperSize! * 2), layoutWidth].reduce(math.max);
...
//             _containerHeight =
//                 [(sliderProperSize! * 2), layoutHeight].reduce(math.max);
...
//     _tooltipData!.leftPrefix = widgetTooltip.leftPrefix ?? const SizedBox();
//     _tooltipData!.leftSuffix = widgetTooltip.leftSuffix ?? const SizedBox();
//     _tooltipData!.rightPrefix = widgetTooltip.rightPrefix ?? const SizedBox();
//     _tooltipData!.rightSuffix = widgetTooltip.rightSuffix ?? const SizedBox();
...
//
//     Color trackBarColor = boxDecoration.color ?? customThemeColor;
//     if (widget.disabled!) {
